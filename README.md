...
| [`dotpkg`](https://github.com/xom11/dotpkg) | winget + scoop from one dotfile — overlay only, **no host installs it** |

The last five are own tools kept in their own repos, as is
